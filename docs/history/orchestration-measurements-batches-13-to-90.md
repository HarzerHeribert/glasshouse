# `orchestration-measurements.md` archive — batches 13 to 90

Moved out of `docs/process/orchestration-measurements.md` by
GH-CLEANUP-DOCS-HISTORY, 2026-09-16: batches 13–14 through 90
(2026-08-26 to 2026-09-02), kept verbatim and in order. Nothing here is
current guidance; the live ledger, the last five batches, and the
"Questions the next orchestrator should answer" section are in
`docs/process/orchestration-measurements.md`.
