# `handoff.md` archive — 2026-08-27 to 2026-09-06

Moved out of `docs/process/handoff.md` by GH-CLEANUP-DOCS-HISTORY,
2026-09-16: every `## Checkpoint` section before the five most recent, and
the sections that followed them (current capability/phase, verified
completed work, unresolved loose ends, and the rest of that hand-off), kept
verbatim and in order. Nothing here is current guidance; the live document
is `docs/process/handoff.md`.
