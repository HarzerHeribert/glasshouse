...
| JSON/machine-readable output | ✅ | ✅ | ✅ | **P1** | --output-format json produces schema_version=1 result/events on clean stdout; diagnostics stderr. [session_output](../../../crates/pane/tests/session_output.rs). |
| Stream JSON/events for integrations | ✅ | ✅ | ✅ | **P1** | --output-format stream-json emits ordered typed session/message/cell/result events. Not token deltas. [session_output](../../../crates/pane/tests/session_output.rs). |
