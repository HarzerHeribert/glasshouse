...
| `bootstrap-atomic` | Opus 5 high, RED | dispatched on this commit (no map line — the race's airtight successor: private temp file, one hard link, the wave-108 wait removed); design note *Creating the project database atomically* |
