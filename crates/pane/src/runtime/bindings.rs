...
const CONSOLE_INSPECTION_STOP_CHARS: usize = 128;
...
fn console_rendered_bounded(text: String, cap: usize) -> String {
...
fn charge_console_inspection(remaining: &mut usize, rendered: &str) {
    *remaining = remaining.saturating_sub(rendered.chars().count());
}

fn console_atom(remaining: &mut usize, rendered: impl Into<String>) -> String {
