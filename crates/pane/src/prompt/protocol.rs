...
/// Returns prose with its protocol marker removed only when the marker is the
/// final standalone line outside fenced code and the response contains no
/// attempted executable channel.
