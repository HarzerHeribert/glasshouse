//! This file was `v1_criteria_setup.rs` until 2026-09-02: Windows treats any
//! executable whose name contains *setup* (or *install*, *update*, *patch*)
//! as an installer needing elevation and refuses to start it (`os error
//! 740`), so the test binary named after this file never ran on the Windows
